...
public class IlModel
{
    ...
    {
        return "ClassPojo [saatlikTahminIstNo = "+saatlikTahminIstNo+", aciklama = "+aciklama+", boylam = "+boylam+", il = "+il+", ilce = "+ilce+", gunlukTahminIstNo = "+gunlukTahminIstNo+", alternatifHadiseIstNo = "+alternatifHadiseIstNo+", ilPlaka = "+ilPlaka+", yukseklik = "+yukseklik+", oncelik = "+oncelik+", sondurumIstNo = "+sondurumIstNo+", enlem = "+enlem+", merkezId = "+merkezId+"]";
    }
}