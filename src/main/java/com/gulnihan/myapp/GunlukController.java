...
public class GunlukController {
	...
	public String home(Locale locale, Model model, @RequestParam(value = "il", required = false) String il) {
		...
		ResponseEntity<GunlukHavaDurumuModel[]> result2 = restTemplate.getForEntity(
					"http://212.175.180.28/api/tahminler/gunluk?istno=" + ilBilgisi.getGunlukTahminIstNo(), 
					GunlukHavaDurumuModel[].class);
		GunlukHavaDurumuModel gunlukHavaBilgisi = result2.getBody()[0];
